...
This section defines a mathematical model with which the space and time requirements of a process may be crudely described.

/TODO: is this essentially Big O?/
** 1.2.4 Exponentiation
This section discusses a few implementations of an exponentiation proceduce (ie. ~(expt 2 4)~ == 2^2) and the characteristics of their orders of growth in time and space
